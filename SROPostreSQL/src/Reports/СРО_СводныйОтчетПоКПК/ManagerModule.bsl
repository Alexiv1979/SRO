...
Функция СформироватьТабличныеДокументы(СтруктураПараметров) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
				   ...
				   | 			ИЛИ ВТ_Документы.КодДокумента = ЗНАЧЕНИЕ(Перечисление.КодДокумента.ОКУД_0420820_21651)
				   ...
				   |				ИЛИ ВложенныйЗапрос.КодДокумента = ЗНАЧЕНИЕ(Перечисление.КодДокумента.ОКУД_0420820_21651)
	               |			ТОГДА 5
				   ...
				   |					ИЛИ ВТ_ДокументыОтчетности_2164.КодДокумента = ЗНАЧЕНИЕ(Перечисление.КодДокумента.ОКУД_0420820_21651))
	               |	
	               |	СГРУППИРОВАТЬ ПО
	               |		ВТ_ДокументыОтчетности_2164.КодДокумента,
	               |		ВТ_ДокументыОтчетности_2164.Ссылка,
	...
	Пока ВыборкаПоКодуДокумента.Следующий() Цикл
		...
		ИначеЕсли ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_2164
			...
			ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_2165
			ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_21651 Тогда
		...
		Для Каждого СтрокаРаздела ИЗ ТЗРазделы Цикл 
			...
			Если  (ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_2164
				...
				ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_21644
				ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_2165
				ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_21651) И Лев(СтрокаРаздела.Раздел.Код, 1)= "9" Тогда
				Продолжить; 				 
			ИначеЕсли  ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_2164
				...
				И ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_2165
				И ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_21651 И Лев(СтрокаРаздела.Раздел.Код, 1)= "8" Тогда
				 Продолжить;
			КонецЕсли;
			...
			//	АдресМестонахождения = СокрЛП(ДокументОтчетности.КПКАдресФактическогоМестонахождения);    
				...
				Пока Выборка.Следующий() Цикл 	
					...
					Если  (ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_2164
						...
						ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_21644
						ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_2165
						ИЛИ ВыборкаПоКодуДокумента.КодДокумента = Перечисления.КодДокумента.ОКУД_0420820_21651) И Лев(Выборка.Раздел.Код, 1)= "9" Тогда
						 Продолжить;						 
					 ИначеЕсли  ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_2164
						 И ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_21641
						 И ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_21642
						 И ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_21644
						 И ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_2165
						 И ВыборкаПоКодуДокумента.КодДокумента <> Перечисления.КодДокумента.ОКУД_0420820_21651 И Лев(Выборка.Раздел.Код, 1)= "8" Тогда
						 Продолжить;
					КонецЕсли;
